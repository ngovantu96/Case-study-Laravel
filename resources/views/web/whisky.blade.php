    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('slider/Cognac-2020-03-01.jpeg') }}" class="d-block w-100 carousel-image" alt="..." >
            </div>
            <div class="container title">
                <div class="col-md-12 text-center">
                    <h6 class="text-uppercase font-weight-bold text-white">Whisky</h6>
                    <p class="text-white"> "WHISKY/WHISKEY
                        Whisky được nhắc đến lần đầu tiên vào năm 1736, trong tiếng Gaelic tại Scotland và có nghĩa là "nước của cuộc sống".
                    </p>
                </div>
            </div>
        </div>
